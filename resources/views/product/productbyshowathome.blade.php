        ...
        <div class="SubProductHomePageGroup1">
            <div class="TopBar">
                <div class="TopBarTitle">
                    <h2>
                        <a href="#" title="">Dự án đã thi công</a>
                    </h2>
                </div>    
            </div>
            <div class="cb h0"><!----></div>
            <div class="container-productcate">
                @if($productshowathome)
                @foreach($productshowathome as $product)
                <div class="outerItem">
                    <div class="item">
                        <div class="itemContent">
                            <a class="JsImageFrame" href="{{ URL::to('') }}/product-{{$product->id}}" title="{{$product->title}}">
                                <img alt="{{$product->title}}" class="grow" src="/appfiles/product/{{$product->picture}}" style="position: absolute; z-index: 1; top: 0px; left: -22.4444px; height: 140px; width: 248.889px;">
                            </a>
                            <div class="h9"><!----></div>
                            <h3>
